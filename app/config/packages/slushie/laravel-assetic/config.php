    ...
    */
        ...
        */ 
        ...
        'panel' => array(
            ...
            'assets' => array(
                public_path('assets/js/bootstrap.min.js'),
                public_path('assets/js/bootstrap-datepicker.js'),
                public_path('assets/js/fullcalendar.min.js'),
                public_path('assets/js/markdown.js'),
                public_path('assets/js/panel.js'),
    ...
    'filters' => array(
        ...
        'js_minp'      => 'Assetic\Filter\JSMinPlusFilter',
